...
if ((status = pthread_create (&thread1, NULL, do_greeting, NULL)) !=
0) {
...
//b/c .. main thread terminated before that the new get create and execute the do greating 
// funtion.... since we know that we main thread terminate it also terminate the other thread
